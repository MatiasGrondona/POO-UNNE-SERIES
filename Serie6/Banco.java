...
public class Banco
{
    public static void main (String [] args)
    {
        ...
        System.out.println("Se agrego un saldo de 2000.0 en la Caja De Ahorro N°"+cajaDeAhorro1.getNroCuenta());
        ...
        System.out.println("se agrego un saldo de 700.0 a la Cuenta Corriente N°"+cuentaCorriente1.getNroCuenta());
        cuentaCorriente1.mostrar();
        System.out.println("Se intenta extraer un saldo igual a 800.0 en la Cuenta Corriente N°"+cuentaCorriente1.getNroCuenta());
        cuentaCorriente1.extraer(800.0);
        //Caja de ahorro
